...
define(["js/HoBDetailFetcher", "js/HoBSummaryFetcher"],
   ...
   function(HoBDetailFetcher, HoBSummaryFetcher)
   {
      ...
      HoBPackFetcher.TYPES = ["encounter-side-quest", "enemy", "location", "objective", "objective-ally", "objective-hero", "objective-location", "quest", "ship-enemy", "ship-objective", "treachery"];
