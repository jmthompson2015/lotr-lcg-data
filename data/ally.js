...
},
{
   ...
   "traits": "Gondor.",
   "text": "<b>Response:</b>  After you play Linhir Sea-captain from your hand, if you paid all of its resouce cost from a single hero's resource pool, both that hero and Linhir Sea-captain do not exhaust to quest this round.",
   "is_unique": false,
   "cost": "3",
   "willpower": 2,
   "attack": 0,
...
},
{
   ...
   "text": "<b>Forced:</b> After this ally enters play, search the top 5 cards of the encounter deck for a non-unique location and add it to the staging area. If no location enters play by this effect, discard Dunedain Pathfinder. Shuffle the encounter deck.",
   "is_unique": false,
   "cost": "0",
   "willpower": 2,
   "attack": 1,
