[
   ...
   },
   {
      ...
      "shadow_text": "<b>Shadow:</b> If this attack is undefended, the damage must be placed on Wilyador",
      "engagement_cost": 26,
      "threat": 1,
      "attack": 1,
      "defense": 0,
   ...
   },
   {
      ...
      "traits": "Undead.",
      "text": "Doomed 1.",
      "shadow_text": "<b>Shadow:</b> Choose and discard 1 attachment you control. Discarded objective cards are returned to the staging area. (If this attack is undefended, discard all attachments you control.)",
      "engagement_cost": 8,
      "threat": 2,
      "attack": 2,
      "defense": 1,
   ...
   },
   {
      ...
      "shadow_text": "<b>Shadow:</b> Deal 1 damage to each character the defending player controls. (2 damage instead if this attack is undefended.)",
      "engagement_cost": 40,
      "threat": 1,
      "attack": 2,
      "defense": 0,
   ...
   },
   {
      ...
      "shadow_text": "<b>Shadow:</b> Defending character gets -1 Defense for the duration of this attack.",
      "engagement_cost": 20,
      "threat": 1,
      "attack": 2,
      "defense": 0,
   ...
   },
   {
      ...
      "shadow_text": "<b>Shadow:</b> Attacking enemy gets +1 Attack (+2 Attack instead if this attack is undefended.)",
      "engagement_cost": 20,
      "threat": 2,
      "attack": 3,
      "defense": 1,
   ...
   },
   {
      ...
      "traits": "Goblin. Orc.",
      "text": "Surge.",
      "shadow_text": "<b>Shadow:</b> Wolf Rider attacks the defending player. That player may declare 1 character as a defender. Deal Wolf Rider its own Shadow card. After combat, return Wolf Rider to the top of the encounter deck.",
      "engagement_cost": 10,
      "threat": 1,
      "attack": 2,
      "defense": 0,
