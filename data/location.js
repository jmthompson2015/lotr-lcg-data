[
   ...
   },
   {
      ...
      "is_unique": true,
      "traits": "Underground.",
      "text": "<b>Travel:</b> Each player must raise his threat by 3 to travel here.<br/><b>Forced: After First Hall leaves play as an explored location, add Bridge of Khazad-dûm to the staging area.",
      "threat": 2,
      "quest_points": 2,
      "quantity_easy": 1,
      "quantity": 0,
   ...
   },
   {
      ...
      "text": "While Branching Paths is in the staging area, each Dark location gets +1 Threat.<br/><b>Forced:</b> After Branching Paths leaves play as an explored location, look at the top 3 cards of the encounter deck. Players must choose 1 of those to reveal and add to the staging area, moving the other 2 to the bottom of the deck.",
      "threat": 1,
      "quest_points": 3,
      "quantity_easy": 1,
      "quantity": 2,
   ...
   },
   {
      ...
      "name": "Goblin Tunnels",
      "traits": "Underground. Dark.",
      "text": "While Goblin Tunnels is in the staging area, it gains:<b>Forced:</b> After a Goblin is revealed from the encounter deck, remove a progress token from the current quest card.",
      "shadow": "<b>Shadow:</b> attacking enemy gets +1 Attack (+3 Attack instead if attacking enemy is a Goblin.)",
      "threat": 2,
      "quest_points": 7,
      "quantity_easy": 2,
      "quantity": 0,
