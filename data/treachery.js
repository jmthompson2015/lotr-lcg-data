[
   ...
   },
   {
      ...
      "position": 40,
      "name": "Burning Low",
      "text": "<b>When Revealed:</b> Each enemy and location currently in the staging area gets +1 Threat until the end of the phase. (+3 Threat instead if it is a Dark location.) Players may exhaust a Cave Torch to cancel this effect.",
   ...
   },
   {
      ...
      "text": "<b>When Revealed:</b> Deal 1 damage to each exhausted character. (2 damage instead if the active location is a Dark location.)",
   ...
   },
   {
      ...
      "position": 62,
      "name": "Watchful Eyes",
      "text": "<b>When Revealed:</b> The first player attaches Watchful Eyes to one of his heroes. Counts as a Condition attachment with the text:Limit 1 per hero. <b>Forced:</b> If attached hero is exhausted at the end of the combat phase, reveal 1 card from the encounter deck and add it to the staging area.",
      "quantity_easy": 0,
      "quantity": 3,
